...
function App() {
  ...
  return (
    <>
      ...
      <FormControlLabel control={<Radio />} label="India" />
      <FormControlLabel
        control={<Radio />}
        label="India"
        labelPlacement="top"
      ...
      <Box sx={{ height: 300 }}>
        <Slider orientation="vertical" defaultValue={40} color="warning" />
      </Box>
      ...
      <Box fontWeight={800}>Hello</Box>

      <h1>Font size</h1>
      <Box fontSize={10}>Hello</Box>

      <h1>Font Style</h1>
      <Box fontStyle="italic">Hello Utkarsh</Box>
      ...
      <Box pt={10}>top padding</Box>
      <Box pb={10}>bottom padding</Box>
      <Box pl={10}>left padding</Box>
      <Box pr={10}>right padding</Box>
      <Box px={10}>left right padding</Box>
      <Box py={10}>top bottom padding</Box>
    ...
    <Stack direction="row" spacing={1}>
      ...
      <Chip avatar={<Avatar src="https://cdn.pixabay.com/photo/2016/11/29/09/29/woman-1868717_960_720.jpg" />} label="Avatar Chip" />
    </Stack>
      ...
      <Table>
        ...
        <TableBody>
          <TableRow>
            ...
            <TableCell align="right">Utkarsh</TableCell>
          ...
          <TableRow>
            ...
            <TableCell align="right">058</TableCell>
            <TableCell align="right">12</TableCell>
